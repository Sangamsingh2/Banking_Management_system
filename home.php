...
<nav class="navbar navbar-expand-xl navbar-light bg-light">
	<a href="home.php" class="navbar-brand"><img src="images/charusat_symbol.jpg" width="45" alt="" class="logo-img"><b>SDS Bank</b></a>
      ...
      <section class="light">
		...
		<article class="postcard light blue">
			...
			<div class="postcard__text t-dark">
				<h1 class="postcard__title blue"><a href="#">Welcome to SDS Bank</a></h1>
				
				<div class="postcard__bar"></div>
				<div class="postcard__preview-txt"><b>SDS Bank</b> is the biggest commercial bank in India. It is a Private sector bank and has its headquarters in Indore, Madhya Pradesh. It has a total of 16 regional hubs and 57 zonal offices located at almost every city throughout India.</div>
